...
@ConfigSection("embed.support")
@ConfigFile("embed.yml")
public class SupportTicketEmbedValue implements ConfigurationInjectable {

    @Getter private static final SupportTicketEmbedValue instance = new SupportTicketEmbedValue();
    ...
    public static <T> T get(Function<SupportTicketEmbedValue, T> function) {
