...
@ConfigSection("embed.server")
@ConfigFile("embed.yml")
public class ServerEmbedValue implements ConfigurationInjectable {

    @Getter private static final ServerEmbedValue instance = new ServerEmbedValue();
    ...
    public static <T> T get(Function<ServerEmbedValue, T> function) {
