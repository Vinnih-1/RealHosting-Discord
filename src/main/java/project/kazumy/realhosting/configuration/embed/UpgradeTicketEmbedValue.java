...
@ConfigSection("embed.upgrade")
@ConfigFile("embed.yml")
public class UpgradeTicketEmbedValue implements ConfigurationInjectable {

    @Getter private static final UpgradeTicketEmbedValue instance = new UpgradeTicketEmbedValue();
    ...
    public static <T> T get(Function<UpgradeTicketEmbedValue, T> function) {
