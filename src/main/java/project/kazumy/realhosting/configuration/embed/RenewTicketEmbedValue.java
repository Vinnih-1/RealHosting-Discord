...
@ConfigSection("embed.renew")
@ConfigFile("embed.yml")
public class RenewTicketEmbedValue implements ConfigurationInjectable {

    @Getter private static final RenewTicketEmbedValue instance = new RenewTicketEmbedValue();
    ...
    public static <T> T get(Function<RenewTicketEmbedValue, T> function) {
