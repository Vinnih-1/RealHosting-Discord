...
public class AddUserTicketModalInteraction extends InteractionService<ModalInteractionEvent> {

    private final DiscordMain discordMain;

    public AddUserTicketModalInteraction(DiscordMain discordMain) {
