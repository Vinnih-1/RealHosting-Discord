...
public class AddUserTicketButtonInteraction extends InteractionService<ButtonInteractionEvent> {

    private final DiscordMain discordMain;

    public AddUserTicketButtonInteraction(DiscordMain discordMain) {
