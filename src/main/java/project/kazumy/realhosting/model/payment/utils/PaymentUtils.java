package project.kazumy.realhosting.model.payment.utils;
...
public class PaymentUtils {
    ...
    @SneakyThrows
    public static File getAsImage(String userId, String qrData) {
        val qr = QrCode.encodeText(qrData, QrCode.Ecc.MEDIUM);
        val img = toImage(qr, 10, 4);

        val qrCodeImage = new File( "services/payment/qrcode/" + userId + ".png");
        qrCodeImage.mkdirs();
